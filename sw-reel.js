const CACHE_NAME = 'guia-reel-app-v1';
const TILE_CACHE = 'guia-reel-tiles-v1';
const IMG_CACHE  = 'guia-reel-imgs-v1';
const LIB_CACHE  = 'guia-reel-libs-v1';
const TRACK_CACHE = 'guia-reel-tracks-v1';
    ...
    e.respondWith(
      fetch(e.request).then(function(res) {
        ...
        return caches.match(e.request, { ignoreSearch: true }).then(function(cached) {
          if (cached) return cached;
          return caches.match('reel.html', { ignoreSearch: true });
